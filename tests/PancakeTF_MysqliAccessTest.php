<?php
require_once dirname(__FILE__) . "/../classes/PancakeTF_MysqliAccess.class.php";

class PancakeTF_MysqliAccessTest extends PHPUnit_Framework_Testcase{
	...
	public function testConnection(){
    	...
    	$this->assertTrue($this->db instanceof PancakeTF_MysqliAccess);
	}
